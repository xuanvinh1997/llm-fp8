...
\textbf{Hardware Requirements:} Our FP8 optimization requires NVIDIA RTX 6000 Pro GPUs with native FP8 Tensor Core support. This hardware dependency limits immediate applicability to organizations with access to these advanced accelerators.
