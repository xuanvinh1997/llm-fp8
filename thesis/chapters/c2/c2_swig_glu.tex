...
Empirical gains &
Adopted by PaLM \cite{chowdhery2023palm}, LLaMA-2 \cite{touvron2023llama}, Qwen-2.5 \cite{qwen25}, DeepSeek \cite{deepseekv3}, showing \mbox{+0.3–0.5} BLEU on WMT-En$\to$De and lower cross-entropy vs.\ GELU. \\ \bottomrule
\end{tabular}
\end{center}
...
Support ships with \texttt{FlashAttention\,2} \cite{dao2023flashattention2}, \texttt{Transformer-Engine}, and
