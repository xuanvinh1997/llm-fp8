...
\midrule
Llama-3.2-3B  & 32 & 3\,072 & 32 & 3.21 B & 128\,000 \\
...
\textbf{Positional Encodings:} Positional information is injected via Rotary Position Embeddings (RoPE) \cite{su2024roformer}, which apply rotation matrices to query and key vectors in the attention mechanism. RoPE enables better extrapolation to longer sequences and provides improved relative position modeling compared to absolute positional encodings.
