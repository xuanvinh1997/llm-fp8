...
For each setting, we measured token throughput (tokens per second) and peak GPU memory consumption. The results of this analysis, presented in Chapter \ref{chap:results}, demonstrate the practical benefits of FP8 training when deployed in a production-like inference scenario.
