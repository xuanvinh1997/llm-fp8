...
class FP8Handler:
    ...
    def _create_mxfp8_kwargs():
        ...
        if not mxfp8_options:
            import warnings
            warnings.warn(
                "MXFP8 scenario requested but no MXFP8 format is available. "
                "Falling back to default FP8 recipe.",
                stacklevel=2,
            )
            return [FP8RecipeKwargs()]
        ...
        return [FP8RecipeKwargs(recipe=recipe)]
